...
def list_hearings(
    ...
    return q.order_by(models.Hearing.hearing_date.desc()).offset(skip).limit(limit).all()
...
def create_hearing(
    ...
    hearing_data = hearing_in.dict()
    hearing_data["cnr_number"] = case.cnr_number

    hearing = models.Hearing(**hearing_data)
